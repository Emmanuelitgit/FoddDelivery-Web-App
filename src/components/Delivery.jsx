...
const Delivery = () => {
  return (
    <div className='w-full bg-white py-16 px-4'>
        <h3 className='text-green-500  font-bold text-2xl text-center'>Quick Delivery App</h3>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center'>
                <p className='text-[#00df] font-bold'>Download The App And Get Started</p>
            ...
            eveniet ex deserunt fuga?
                ...
                <button className='bg-green text-[#009a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3'>Download</button>
            </div>
        </div>
    </div>
  )
